...
export default function FAQ() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Yes, you can select your preferred doctor during booking.",
    },
  ];
  ...
  return (
    <section id="faq" className="py-20 scroll-mt-24">
      <div className="max-w-4xl mx-auto px-6">
        ...
        {faqs.map((faq, index) => (
          <div key={index} className="border rounded-xl mb-4 overflow-hidden">
            <button
            ...
            {open === index && (
              <div className="p-5 bg-gray-50">{faq.answer}</div>
            )}
          </div>
        ))}
      </div>
